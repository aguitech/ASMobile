...
public class Detalle_escanear extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ListView lv;
    ...
    public Detalle_escanear mActivity = this;
    public PagosAdapter _mascotasAdapter;

    public Detalle_escanear _activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_escanear);
        ...
        */
        ...
        new Detalle_escanear.RetrieveFeedTaskGet().execute();
...
<p>        // If you would like to resume scanning, call this method below:<br />
    ...
    */
    ...
    public void goBack(View v){
        ...
        Intent i = new Intent(Detalle_escanear.this, Lista_contratos.class);
        startActivity(i);
    }
    public void goAgregarPago(View v){
        Intent i = new Intent(Detalle_escanear.this, Agregar_pago.class);
    ...
    public void goMenu(View v){
        Intent i = new Intent(Detalle_escanear.this, Menu.class);
        startActivity(i);
    }
